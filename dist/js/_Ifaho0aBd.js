...
var Cn = (e, o, t) =>
  o in e
    ? Pn(e, o, { enumerable: !0, configurable: !0, writable: !0, value: t })
    : (e[o] = t);
var M = (e, o, t) => Cn(e, typeof o != "symbol" ? o + "" : o, t),
  Ot = (e, o, t) => o.has(e) || So("Cannot " + t);
var d = (e, o, t) => (
    Ot(e, o, "read from private field"),
    t ? t.call(e) : o.get(e)
  ),
  L = (e, o, t) =>
    o.has(e)
      ...
      : o instanceof WeakSet
        ...
        : o.set(e, t),
  I = (e, o, t, n) => (
    Ot(e, o, "write to private field"),
    n ? n.call(e, t) : o.set(e, t),
    t
  ),
  ...
  document.addEventListener(
    ...
    (o) => {
      ...
      if (t && t.method === "dialog") {
        ...
        let r = o.submitter?.value ?? "",
          i = n.beforeClose(r);
        if (
          i === !0 ||
          (o.preventDefault(), o.stopImmediatePropagation(), i === !1)
        )
          return;
        i.then((s) => {
          s && ((e = !0), t.dispatchEvent(o));
        }).catch(console.error);
      }
    },
    !0,
...
function Mo(e, o, t) {
  Lo.set(
    ...
    setTimeout(() => {
      Lo.has(e) &&
        e.dispatchEvent(
          new at("toggle", { cancelable: !1, oldState: o, newState: t }),
        );
    }, 0),
  );
}
...
function Dn(e) {
  ...
  let t = it(o);
  (e.popoverTargetAction === "show" && t === "showing") ||
    (e.popoverTargetAction === "hide" && t === "hidden") ||
    (t === "showing" ? Se(o, !0, !0) : pe(o, !1) && (st.set(o, e), Rt(o)));
}
function pe(e, o) {
  return !(
...
function Io(e) {
  if (!e) return 0;
  let o = X.get(document) || new Set(),
    t = q.get(document) || new Set();
  return t.has(e)
    ? [...t].indexOf(e) + o.size + 1
    : o.has(e)
      ? [...o].indexOf(e) + 1
      : 0;
}
...
function Ve(e) {
  let o,
    t = q.get(e) || new Set(),
    n = X.get(e) || new Set(),
    r = t.size > 0 ? t : n.size > 0 ? n : null;
  return r ? ((o = qe(r)), o.isConnected ? o : (r.delete(o), Ve(e))) : null;
}
function ko(e) {
  for (let o of e || [])
    if (!o.isConnected) e.delete(o);
    else return o;
  return null;
}
function Te(e) {
...
function Ho(e) {
  for (; e; ) {
    ...
    if (
      ((e =
        (e instanceof Element && e.assignedSlot) || e.parentElement || Te(e)),
      e instanceof Nt && (e = e.host),
...
function Bn(e) {
  ...
  if (t) return t;
  {
    ...
    for (let s of i) {
      let a = s.assignedElements({ flatten: !0 });
      for (let l of a) {
...
function Rt(e) {
  ...
  let t = !1,
    n = e.popover,
    r = null,
    i = Po(e, X.get(o) || new Set()),
    s = Po(e, q.get(o) || new Set());
  if (
    (n === "auto" &&
      (Bt(q.get(o) || new Set(), t, !0), me(i || o, t, !0), (r = "auto")),
    n === "hint" &&
      (s
        ? (me(s, t, !0), (r = "hint"))
        : (Bt(q.get(o) || new Set(), t, !0),
          i ? (me(i, t, !0), (r = "auto")) : (r = "hint"))),
    n === "auto" || n === "hint")
  ) {
    if (n !== e.popover || !pe(e, !1)) return;
    (Ve(o) || (t = !0),
      r === "auto"
        ? (X.has(o) || X.set(o, new Set()), X.get(o).add(e))
        : r === "hint" && (q.has(o) || q.set(o, new Set()), q.get(o).add(e)));
  }
  lt.delete(e);
  let a = o.activeElement;
  (e.classList.add(":popover-open"),
    xe.set(e, "showing"),
    rt.has(o) || rt.set(o, new Set()),
    rt.get(o).add(e),
    Ro(st.get(e), !0),
    Nn(e),
    t && a && e.popover === "auto" && lt.set(e, a),
    Mo(e, "closed", "open"));
}
function Se(e, o = !1, t = !1) {
  var n, r;
  if (!pe(e, !0)) return;
  let i = e.ownerDocument;
  if (["auto", "hint"].includes(e.popover) && (me(e, o, t), !pe(e, !0))) return;
  let s = X.get(i) || new Set(),
    a = s.has(e) && qe(s) === e;
  if (
    (Ro(st.get(e), !1),
    st.delete(e),
    ...
    return;
  ((n = rt.get(i)) == null || n.delete(e),
    s.delete(e),
    (r = q.get(i)) == null || r.delete(e),
...
function me(e, o, t) {
  ...
  (Bt(q.get(i) || new Set(), o, t),
    (r = X.get(i)) != null && r.has(e) && Co(e, X.get(i), o, t));
}
var Dt = new WeakMap();
function Oo(e) {
...
function No() {
  ...
  function e(l) {
    return (
      l?.includes(":popover-open") && (l = l.replace(qn, "$1.\\:popover-open")),
      l
    );
  }
  (de(Document.prototype, "querySelector", e),
    ...
    Object.defineProperties(HTMLElement.prototype, {
      ...
      togglePopover: {
        ...
        value(l = {}) {
          return (
            typeof l == "boolean" && (l = { force: l }),
            (xe.get(this) === "showing" && l.force === void 0) || l.force === !1
              ? Se(this, !0, !0)
              : (l.force === void 0 || l.force === !0) && Rt(this),
            xe.get(this) === "showing"
          );
        },
      },
    ...
    Object.defineProperties(l.prototype, {
      popoverTargetElement: {
        ...
        get() {
          ...
          let g = Te(this),
            m = this.getAttribute("popovertarget");
          return (
            ((g instanceof Document || g instanceof Do) &&
              m &&
              g.getElementById(m)) ||
            null
          );
  ...
  let i = (l) => {
      ...
      let c = u.find((b) => {
        var f;
        return (f = b.matches) == null
          ? void 0
          : f.call(b, "[popovertargetaction],[popovertarget]");
      });
      if (c) {
...
function qo() {
  (document.addEventListener(
    ...
    (f) => {
      f.type == "invoke" &&
        f.isTrusted &&
        (f.stopImmediatePropagation(), f.preventDefault());
    },
    !0,
  ),
    document.addEventListener(
  ...
  function o(f) {
    return f && typeof f.getRootNode == "function"
      ? f.getRootNode()
      : f && f.parentNode
        ? o(f.parentNode)
        : f;
    ...
    Object.defineProperties(f.prototype, {
      commandForElement: {
        ...
        get() {
          ...
          let p = o(this),
            v = this.getAttribute("commandfor");
          return (
  ...
  Object.defineProperties(HTMLElement.prototype, {
    oncommand: {
      ...
      set(f) {
        ...
        (h && this.removeEventListener("command", h),
          l.set(
            this,
            typeof f == "object" || typeof f == "function" ? f : null,
          ),
          typeof f == "function" && this.addEventListener("command", f));
      },
    },
  });
  function u(f) {
  ...
  function m(f) {
    ...
    if (p.hasAttribute("command") !== p.hasAttribute("commandfor")) {
      let w = p.hasAttribute("command") ? "command" : "commandfor",
        E = p.hasAttribute("command") ? "commandfor" : "command";
      throw new Error(
        `Element with ${w} attribute must also have a ${E} attribute to function.`,
      );
    }
    if (
      p.command !== "show-popover" &&
      p.command !== "hide-popover" &&
      p.command !== "toggle-popover" &&
      p.command !== "show-modal" &&
      p.command !== "close" &&
      !p.command.startsWith("--")
    ) {
      console.warn(
        `"${p.command}" is not a valid command value. Custom commands must begin with --`,
      );
      return;
    }
    let v = p.commandForElement;
    if (!v) return;
    let y = new r("command", { command: p.command, source: p, cancelable: !0 });
    if ((v.dispatchEvent(y), y.defaultPrevented)) return;
    let T = y.command.toLowerCase();
    if (v.popover) {
      let w = !v.matches(":popover-open");
      w && (T === "toggle-popover" || T === "show-popover")
        ? v.showPopover({ source: p })
        : !w && T === "hide-popover" && v.hidePopover();
  ...
  (a(HTMLButtonElement),
    b(HTMLElement, (f) => {
      (c(f),
        g.observe(f, { attributeFilter: ["oncommand"] }),
        u(f.querySelectorAll("[oncommand]")));
    }),
    c(document),
...
function Vo() {
  ...
  return (
    o.addEventListener("beforetoggle", (t) => {
...
function Wo() {
  let e = new WeakMap();
  function o(s) {
    let a = s.open ? "closed" : "open",
      l = s.open ? "open" : "closed";
    if (e.has(s)) {
      let u = e.get(s);
    ...
    e.set(s, {
      ...
      id: setTimeout(() => {
        s.dispatchEvent(
          new ToggleEvent("toggle", { newState: a, oldState: l }),
        );
      }),
    });
  }
  let t = HTMLDialogElement.prototype.show,
    n = HTMLDialogElement.prototype.showModal,
    r = HTMLDialogElement.prototype.close;
  function i(s) {
    let a = new ToggleEvent("beforetoggle", {
      newState: "closed",
      oldState: "open",
      cancelable: !1,
    });
    ...
    Object.defineProperties(HTMLDialogElement.prototype, {
      show: {
        value() {
          ...
          let s = new ToggleEvent("beforetoggle", {
            newState: "open",
            oldState: "closed",
            cancelable: !0,
          });
...
function ut(e) {
  function o() {
    document.readyState !== "loading" &&
      (e(), document.removeEventListener("DOMContentLoaded", o));
  }
  typeof window < "u" &&
    typeof document < "u" &&
    (document.addEventListener("DOMContentLoaded", o), o());
}
  ...
  for (let o of document.styleSheets)
    try {
      for (let t of o.rules)
        if (
          t.constructor.name === "CSSLayerStatementRule" &&
          "nameList" in t &&
          t.nameList.includes(e)
        )
          return !0;
    } catch {}
  return !1;
...
if (typeof globalThis.window < "u") {
  let e;
  (((n) => ((n[(n.Keyboard = 0)] = "Keyboard"), (n[(n.Mouse = 1)] = "Mouse")))(
    e || (e = {}),
  ),
    document.addEventListener(
      "keydown",
  ...
  A = class extends HTMLElement {
    ...
    connectedCallback() {
      if (
        ...
        typeof this.constructor.observedAttributes == "object" &&
    ...
    setAttributeNoCallbacks(t, n) {
      try {
        (I(this, se, !0), this.setAttribute(t, n));
      } finally {
        I(this, se, !1);
      }
    }
    removeAttributeNoCallbacks(t) {
      try {
        (I(this, se, !0), this.removeAttribute(t));
      } finally {
        I(this, se, !1);
      }
    }
    attributeChangedCallback(t, n, r) {
      d(this, We) &&
        (d(this, se) || (n !== r && this.onAttributeChange?.(t, n, r)));
    }
  };
    ...
    o = {
      addEventListener(t, n, r, i) {
        return (
          ...
          o.add(() => t.removeEventListener(n, r, i))
        );
      },
...
function Ft(e, o) {
  ...
  let r =
    e
      ...
      .filter((i) => i instanceof CSSTransition) ?? [];
  return r.length === 0
    ? (o(), t.dispose)
...
function qt(e) {
  return (e.getAnimations?.() ?? []).some(
    (t) => t instanceof CSSTransition && t.playState !== "finished",
  );
}
var Pe = Math.min,
  Z = Math.max,
...
function jo(e, o, t, n) {
  let r = pt(e),
    i = Qn(he(e), t === "start", n);
  return (
    r && ((i = i.map((s) => s + "-" + r)), o && (i = i.concat(i.map(ft)))),
    i
  );
}
function $e(e) {
...
var Yo = async (e, o, t) => {
  let {
    ...
    a = i.filter(Boolean),
    l = await (s.isRTL == null ? void 0 : s.isRTL(o)),
    u = await s.getElementRects({ reference: e, floating: o, strategy: r }),
    { x: g, y: m } = Go(u, n, l),
    c = n,
    b = {},
    f = 0;
...
async function Kt(e, o) {
  var t;
  o === void 0 && (o = {});
  let { x: n, y: r, platform: i, rects: s, elements: a, strategy: l } = e,
    {
    ...
    f = zo(b),
    p = a[c ? (m === "floating" ? "reference" : "floating") : m],
    v = ge(
      await i.getClippingRect({
        element:
          (t = await (i.isElement == null ? void 0 : i.isElement(p))) == null ||
          t
            ? p
            : p.contextElement ||
    ...
    y =
      m === "floating"
        ...
        : s.reference,
    T = await (i.getOffsetParent == null
      ? void 0
      : i.getOffsetParent(a.floating)),
    w = (await (i.isElement == null ? void 0 : i.isElement(T)))
  ...
  return {
    top: (v.top - E.top + f.top) / w.y,
    bottom: (E.bottom - v.bottom + f.bottom) / w.y,
    left: (v.left - E.left + f.left) / w.x,
    right: (E.right - v.right + f.right) / w.x,
  };
}
var Qo = function (e) {
  return (
    e === void 0 && (e = {}),
    {
      ...
      async fn(o) {
        ...
        let S = [a, ...E],
          $ = await Kt(o, p),
          re = [],
          D = ((n = i.flip) == null ? void 0 : n.overflows) || [];
        if ((g && re.push($[v]), m)) {
          let ce = Ko(r, s, w);
          re.push($[ce[0]], $[ce[1]]);
        }
        if (
          ((D = [...D, { placement: r, overflows: re }]),
          !re.every((ce) => ce <= 0))
        ) {
          var nt, xo;
          let ce = (((nt = i.flip) == null ? void 0 : nt.index) || 0) + 1,
            Ct = S[ce];
          if (
            Ct &&
            (!(m === "alignment" ? y !== le(Ct) : !1) ||
              D.every((_) => (le(_.placement) === y ? _.overflows[0] > 0 : !0)))
          )
            return {
              data: { index: ce, overflows: D },
              reset: { placement: Ct },
            };
          let Fe =
            (xo = D.filter((fe) => fe.overflows[0] <= 0).sort(
              (fe, _) => fe.overflows[1] - _.overflows[1],
            )[0]) == null
              ? void 0
              : xo.placement;
          if (!Fe)
                ...
                let fe =
                  (To = D.filter((_) => {
                    ...
                    .map((_) => [
                      ...
                      _.overflows
                        .filter((ie) => ie > 0)
                        .reduce((ie, kn) => ie + kn, 0),
                    ])
                    .sort((_, ie) => _[1] - ie[1])[0]) == null
                    ? void 0
                    : To[0];
                fe && (Fe = fe);
                break;
  ...
  return (
    e === void 0 && (e = {}),
    {
      ...
      async fn(o) {
        ...
        return {
          ...h,
          data: { x: h.x - t, y: h.y - n, enabled: { [c]: i, [m]: s } },
        };
      },
    }
  );
...
function R(e) {
  var o;
  return (
    (e == null || (o = e.ownerDocument) == null ? void 0 : o.defaultView) ||
    window
  );
}
function U(e) {
  var o;
  return (o = (Zo(e) ? e.ownerDocument : e.document) || window.document) == null
    ? void 0
    : o.documentElement;
}
function Zo(e) {
  return mt() ? e instanceof Node || e instanceof R(e).Node : !1;
}
function V(e) {
  return mt() ? e instanceof Element || e instanceof R(e).Element : !1;
}
function j(e) {
  return mt() ? e instanceof HTMLElement || e instanceof R(e).HTMLElement : !1;
}
function Jo(e) {
...
function ht(e) {
  let o = gt(),
    t = V(e) ? W(e) : e;
  return (
    tr.some((n) => (t[n] ? t[n] !== "none" : !1)) ||
    (t.containerType ? t.containerType !== "normal" : !1) ||
    (!o && (t.backdropFilter ? t.backdropFilter !== "none" : !1)) ||
    (!o && (t.filter ? t.filter !== "none" : !1)) ||
    or.some((n) => (t.willChange || "").includes(n)) ||
    nr.some((n) => (t.contain || "").includes(n))
  );
}
function tn(e) {
  let o = ee(e);
...
function sn(e) {
  let o = W(e),
    t = parseFloat(o.width) || 0,
    n = parseFloat(o.height) || 0,
    r = j(e),
    i = r ? e.offsetWidth : t,
    s = r ? e.offsetHeight : n,
    a = _e(t) !== i || _e(n) !== s;
...
function De(e) {
  ...
  let t = o.getBoundingClientRect(),
    { width: n, height: r, $: i } = sn(o),
    s = (i ? _e(t.width) : t.width) / n,
    a = (i ? _e(t.height) : t.height) / r;
  return (
...
function ln(e) {
  let o = R(e);
  return !gt() || !o.visualViewport
    ? ir
    : { x: o.visualViewport.offsetLeft, y: o.visualViewport.offsetTop };
}
function sr(e, o, t) {
  return (o === void 0 && (o = !1), !t || (o && t !== R(e)) ? !1 : o);
}
function we(e, o, t, n) {
  ...
  if (i) {
    ...
    for (; h && n && b !== f; ) {
      let p = De(h),
        ...
        y = W(h),
        T = v.left + (h.clientLeft + parseFloat(y.paddingLeft)) * p.x,
        w = v.top + (h.clientTop + parseFloat(y.paddingTop)) * p.y;
      ((l *= p.x),
        (u *= p.y),
        (g *= p.x),
        (m *= p.y),
...
function an(e, o, t) {
  ...
  let n = e.getBoundingClientRect(),
    r = n.left + o.scrollLeft - (t ? 0 : zt(e, n)),
    i = n.top + o.scrollTop;
  return { x: r, y: i };
}
function lr(e) {
  let { elements: o, rect: t, offsetParent: n, strategy: r } = e,
    i = r === "fixed",
    s = U(n),
    a = o ? Ue(o.floating) : !1;
  if (n === s || (a && i)) return t;
  ...
  let c = s && !m && !i ? an(s, l, !0) : K(0);
  return {
    width: t.width * u.x,
    height: t.height * u.y,
    x: t.x * u.x - l.scrollLeft * u.x + g.x + c.x,
    y: t.y * u.y - l.scrollTop * u.y + g.y + c.y,
  };
}
function ar(e) {
...
function ur(e) {
  let o = U(e),
    ...
    r = Z(o.scrollWidth, o.clientWidth, n.scrollWidth, n.clientWidth),
    i = Z(o.scrollHeight, o.clientHeight, n.scrollHeight, n.clientHeight),
    s = -t.scrollLeft + zt(e),
    a = -t.scrollTop;
  return (
    W(n).direction === "rtl" && (s += Z(o.clientWidth, n.clientWidth) - r),
...
function un(e, o) {
  let t = ee(e);
  return t === o || !V(t) || ve(t) ? !1 : W(t).position === "fixed" || un(t, o);
}
function pr(e, o) {
  let t = o.get(e);
  if (t) return t;
  let n = Ce(e, [], !1).filter((a) => V(a) && be(a) !== "body"),
    r = null,
  ...
  for (; V(s) && !ve(s); ) {
    ...
    (!l && a.position === "fixed" && (r = null),
      (
        i
          ? !l && !r
          : (!l && a.position === "static" && !!r && fr.has(r.position)) ||
            (Oe(s) && !l && un(e, s))
      )
        ? (n = n.filter((g) => g !== s))
        : (r = a),
...
function mr(e) {
  let { element: o, boundary: t, rootBoundary: n, strategy: r } = e,
    s = [
      ...(t === "clippingAncestors"
        ? Ue(o)
          ? []
    ...
    l = s.reduce(
      (u, g) => {
        ...
        return (
          (u.top = Z(m.top, u.top)),
          (u.right = Pe(m.right, u.right)),
          (u.bottom = Pe(m.bottom, u.bottom)),
          (u.left = Z(m.left, u.left)),
          u
        );
      },
      nn(o, a, r),
...
function gr(e, o, t) {
  ...
  i && !n && r && u();
  let g = r && !n && !i ? an(r, a) : K(0),
    m = s.left + a.scrollLeft - l.x - g.x,
    c = s.top + a.scrollTop - l.y - g.y;
...
var br = async function (e) {
  let o = this.getOffsetParent || cn,
    t = this.getDimensions,
    n = await t(e.floating);
  return {
    reference: gr(e.reference, await o(e.floating), e.strategy),
...
function fn(e, o) {
  return (
    e.x === o.x && e.y === o.y && e.width === o.width && e.height === o.height
  );
}
function wr(e, o) {
  let t = null,
  ...
  function s(a, l) {
    ...
    let u = e.getBoundingClientRect(),
      { left: g, top: m, width: c, height: b } = u;
    if ((a || o(), !c || !b)) return;
    let f = Ke(m),
      h = Ke(r.clientWidth - (g + c)),
      p = Ke(r.clientHeight - (m + b)),
      v = Ke(g),
      T = {
    ...
    function E(k) {
      ...
      (S === 1 && !fn(u, e.getBoundingClientRect()) && s(), (w = !1));
    }
    try {
...
function dn(e, o, t, n) {
  ...
  let {
    ...
    g = r || i ? [...(u ? Ce(u) : []), ...Ce(o)] : [];
  g.forEach((v) => {
    (r && v.addEventListener("scroll", t, { passive: !0 }),
      i && v.addEventListener("resize", t));
  });
  let m = u && a ? wr(u, t) : null,
    c = -1,
    b = null;
  s &&
  ...
  return (
    ...
    () => {
      var v;
      (g.forEach((y) => {
        (r && y.removeEventListener("scroll", t),
          i && y.removeEventListener("resize", t));
      }),
        m?.(),
...
function bn(e) {
  ...
  return function (n, r) {
    ...
    let i = e.getAttribute("anchor"),
      s = e.getAttribute("anchor-strategy") || "absolute";
    (s !== "absolute" &&
      s !== "fixed" &&
      (console.warn(
        `[createAnchorUpdater] Invalid anchor strategy "${s}" for element:`,
        e,
      ),
      (s = "absolute")),
      (o = dn(r, e, () => {
        ...
        hn(r, e, {
          strategy: s,
          placement: i.replace(" ", "-"),
          middleware: [mn({ padding: g }), pn({ padding: g })],
        }).then(async ({ x: m, y: c, placement: b }) => {
          if (!yr() && s === "absolute") {
            let p = null;
          ...
          switch (b.split("-")[0]) {
            case "top":
              ((h = `calc(${c}px - var(--anchor-gap, 0px))`),
                (f = `calc(${m}px + var(--anchor-offset, 0px))`));
              break;
            case "right":
              ((f = `calc(${m}px + var(--anchor-gap, 0px))`),
                (h = `calc(${c}px + var(--anchor-offset, 0px))`));
              break;
            case "bottom":
              ((h = `calc(${c}px + var(--anchor-gap, 0px))`),
                (f = `calc(${m}px + var(--anchor-offset, 0px))`));
          ...
          (Object.assign(e.style, { left: f, top: h, position: s }),
            (await Gt.isRTL?.(e)) &&
...
function gn(e, o) {
  ...
  (o.appendChild(t),
    t.style.setProperty("margin-top", "0px", "important"),
    t.style.setProperty("margin-top", e, "important"));
...
ut(() => {
  function e(o) {
    ...
    t &&
      "closest" in t &&
      ((t = t.closest(ae)),
      N.unshift(t ?? o.target),
      (N = N.filter((n) => n != null && n.isConnected)),
      N.splice(10));
  }
...
function Me(e, o, t, n, r, i) {
  ...
  for (let c of u)
    (c.setAttribute("type", "button"),
      ...
      c.setAttribute("aria-controls", e.id),
  ...
  (o.addEventListener("abort", () => m.abort()),
    e.addEventListener(
      "beforetoggle",
      (c) => {
        let b = vt(c, u);
        (a(c.newState === "open", n?.() ?? b),
          c.newState === "open"
            ? b && (Ge(b, m.signal, g), Ge(e, m.signal, g))
        ...
        (c.newState === "open" && !f
          ...
          c.newState === "open"
            ? (b?.setAttribute("aria-expanded", "true"),
              b?.id && e.setAttribute("aria-labelledby", b.id),
              r?.(),
            ...
            : (b?.setAttribute("aria-expanded", "false"),
              ...
              i?.(),
              (Jt = !1)),
          c.oldState === "closed" && c.newState === "open"
            ? (Ye && (l.dispose(), (l = J())), s.start("in"))
            : c.oldState === "open" &&
              c.newState === "closed" &&
              (Ye && l.style(e, "transition-property", "none"),
              s.start("out")));
      },
      { signal: o },
    ),
    o.addEventListener("abort", () => s.abort()));
}
function vt(e, o) {
  ...
  e.addEventListener(
    ...
    () => {
      Jt &&
        ...
        o && clearTimeout(o),
        (o = setTimeout(() => e.body.removeAttribute("tabindex"))));
    },
    { capture: !0 },
  );
}
function z(e, o, t, n) {
  ...
  (s.observe(e),
    i.addEventListener("transitionend", r, { signal: t }),
    t.addEventListener("abort", () => s.disconnect()));
}
var Tr = 0;
function P(e) {
  return `${e}-${Tr++}`;
...
function yt(e) {
  ...
  if ((o.referenceCounter++, o.referenceCounter === 1)) {
    let n = [Cr(), kr(), Ir()];
    (n.forEach(({ before: r }) => r({ doc: e, d: o.d })),
  ...
  return () => {
    t ||
      ((t = !0),
      o.referenceCounter--,
      !(o.referenceCounter > 0) && (o.d.dispose(), Tn.delete(e)));
  };
}
function Ir() {
  return {
...
function kr() {
  ...
  return {
    before({ doc: o }) {
      ...
      ((e = Math.max(0, n.innerWidth - t.clientWidth)),
        t.style.setProperty("--el-top-layer-scrollbar-offset", "0px"));
    },
    after({ doc: o, d: t }) {
        ...
        before({ doc: e, d: o }) {
          ...
          o.microTask(() => {
            ...
            (o.addEventListener(
              ...
              o.addEventListener(e, "touchstart", (i) => {
  ...
  eo = class extends A {
    ...
    mount(t) {
      ...
      (n.id || (n.id = P("autocomplete-input")),
        r && (r.id || (r.id = P("autocomplete-button"))),
        i.id || (i.id = P("autocomplete-listbox")),
        Me(
          i,
          t,
          () => {
        ...
        r &&
          ...
          r.setAttribute("popovertarget", i.id)),
      ...
      function l() {
        for (let c of i.getItems())
          a.has(c) ||
            ...
            ue(c, "mouseover", t, () => s.setActiveItem(c, !1)),
            ue(c, "mouseout", t, () => s.clearActiveItem()));
        s.filterOptions();
      }
      l();
      let u = new MutationObserver(l);
      (u.observe(this, { attributes: !1, childList: !0, subtree: !0 }),
        r && z(r, "--button-width", t, this),
        z(n, "--input-width", t, this),
        n.addEventListener(
          "input",
          () => {
            n.matches(":disabled") ||
              (this.filterOptions(),
              d(this, F).length > 0
                ? i.hasAttribute("open") || i.showPopover()
                : i.hidePopover());
          },
          { signal: t },
        ));
      let g = () => {
        n.matches(":disabled") ||
          ...
          i.hasAttribute("open")
            ? i.hidePopover()
            : (this.filterOptions(), d(this, F).length > 0 && i.showPopover()));
      };
      (n.addEventListener("pointerdown", g, { signal: t }),
        r &&
          (r.addEventListener(
            "pointerdown",
            (c) => {
            ...
            if (!n.matches(":disabled"))
              switch (c.key) {
                case "ArrowDown": {
                  (c.preventDefault(),
                    i.hasAttribute("open") ||
                      (d(this, F).length === 0 && this.filterOptions(),
                      d(this, F).length > 0 && i.showPopover()),
                    this.goToItem(3));
                  break;
                }
                case "ArrowUp": {
                ...
                case "Enter": {
                  ...
                  (b && (c.preventDefault(), this.selectOption(b)),
                    i.hasAttribute("open") &&
    ...
    filterOptions() {
      ...
      (d(this, Qe) !== t && (this.clearActiveItem(), I(this, Qe, t)),
        I(this, F, []));
      for (let n of this.getOptions().getItems()) {
        let r = n.getAttribute("value")?.toLowerCase() || "",
          i = At(n)?.trim().toLowerCase() ?? "";
        t === "" || r.includes(t) || i.includes(t)
          ? (d(this, F).push(n),
    ...
    setActiveItem(t, n = !0) {
      ...
      (i !== null && i.setAttribute("aria-selected", "false"),
    ...
    clearActiveItem() {
      ...
      (n !== null && n.setAttribute("aria-selected", "false"),
    ...
    selectOption(t) {
      ...
      r &&
        ((n.value = r),
        n.dispatchEvent(new Event("input", { bubbles: !0, cancelable: !0 })),
        n.dispatchEvent(new Event("change", { bubbles: !0, cancelable: !0 })),
...
var G,
  ...
  oo = class extends A {
    constructor() {
      ...
      L(this, G, []);
      L(this, Xe, null);
      L(this, Je, ({ query: t, content: n }) =>
        n.toLocaleLowerCase().includes(t.toLocaleLowerCase().trim()),
      );
    }
    mount(t) {
      let n = this.getInput(),
        r = this.getItems();
      (n.id || (n.id = P("command-input")),
        r.id || (r.id = P("command-items")),
        n.setAttribute("role", "combobox"),
        n.setAttribute("aria-autocomplete", "list"),
        n.setAttribute("autocomplete", "off"),
      ...
      function a(u = !1) {
        ...
        for (let m of r.getItems())
          s.has(m) ||
            ...
            ue(m, "mouseover", t, () => {
              var c;
              return H((c = i), te, no).call(c, m, !1);
            }));
        (H((g = i), te, xt).call(g, u), u || i.goToItem(0));
      }
      a(!0);
      let l = new MutationObserver(() => a(!1));
      (l.observe(this, { attributes: !1, childList: !0, subtree: !0 }),
        z(n, "--input-width", t, this),
        n.addEventListener("input", () => H(this, te, xt).call(this), {
          signal: t,
        }),
        n.addEventListener(
          "keydown",
...
((G = new WeakMap()),
  ...
  (xt = function (t = !1) {
    let n = this.getItems(),
      r = this.getInput().value ?? "";
    I(this, G, []);
    for (let a of n.getItems()) {
      if (a.closest("el-defaults")) continue;
      let l = Ln(a) ?? "";
      r === "" || !d(this, Je).call(this, { query: r, node: a, content: l })
    ...
    for (let a of this.getGroups())
      a.getItems().some((u) => !u.hasAttribute("hidden"))
        ? a.removeAttribute("hidden")
        : a.setAttribute("hidden", "");
    let i = this.getSuggestions();
    i &&
      (r === ""
        ? (i.removeAttribute("hidden"), I(this, G, i.getItems()))
  ...
  Object.defineProperties(HTMLDialogElement.prototype, {
    close: {
      value(e) {
        ...
        if (t === !0) return He?.call(this, e);
        t !== !1 &&
          t.then((n) => (n ? He?.call(this, e) : null)).catch(console.error);
      },
    },
  }),
  document.addEventListener(
    ...
    (e) => {
      ...
      let n = e.source?.tagName === "BUTTON" ? e.source.value : void 0,
        r = t.beforeClose(n);
      r !== !0 &&
        (e.stopImmediatePropagation(),
        e.preventDefault(),
        r !== !1 &&
          r.then((i) => (i ? He?.call(o, n) : null)).catch(console.error));
    },
    !0,
  ));
var Q,
  ...
  Re = class extends A {
    ...
    mount(t) {
      ...
      Dr(n, t, (a) => {
        a.preventDefault();
        let l = new Event("cancel", { bubbles: !1, cancelable: !0 });
      ...
      (n.addEventListener(
        ...
        (a) => {
          ...
          if (
            ...
            l.newState === "open" && l.oldState === "closed")
          )
            N.length > 0 && !s && (s = N[0]);
            ...
            setTimeout(() => {
              if (!g) {
                s &&
                  ...
                  s.isConnected &&
                  "blur" in s &&
                  typeof s.blur == "function" &&
                  s.blur();
                return;
              }
              (s && s !== document.activeElement && s.isConnected && Le(s),
                (s = null));
            });
          }
        },
        ...
        d(this, ye)?.start("out", () => {
          n.aborted ||
            ...
            requestAnimationFrame(() => {
              let i = this.getNativeDialog(),
                s = i.style.cssText;
              ((i.style.cssText = s + "transition-duration: 0 !important;"),
                He?.call(i, t),
                requestAnimationFrame(() => {
                  i.style.cssText = s;
                }));
...
var co = class extends A {
    mount(o) {
      Or(this, o, () => {
        let t = this.getDialog(),
          n = t.getNativeDialog();
        if (!n.hasAttribute("open")) return;
        let r = new Event("cancel", { bubbles: !1, cancelable: !0 });
  ...
  Tt = class extends A {
    ...
    mount(t) {
      ...
      for (let r of H(this, et, po).call(this))
        (r.setAttribute("aria-expanded", n.toString()),
          r.setAttribute("aria-controls", this.id));
      (this.addEventListener(
        ...
        t.addEventListener("abort", () => d(this, Ne).abort()));
    }
    onAttributeChange(t, n, r) {
      switch (t) {
        case "hidden": {
...
function Lt(e, o, t) {
  ...
  (a.id || (a.id = P(`${o.role}-button`)),
    ...
    e.setAttribute("role", o.role),
    a.setAttribute("popovertarget", e.id),
    a.setAttribute("aria-haspopup", o.role));
  let l = new WeakSet();
  function u() {
    let w = o.getItems(),
      E = { passive: !0, signal: t },
      k = o.role === "menu" ? "menuitem" : "option";
    for (let S of w)
      l.has(S) ||
        (l.add(S),
        S.id || (S.id = P("item")),
        S.setAttribute("role", k),
        S.setAttribute("tabIndex", "-1"),
        S.addEventListener("click", () => o.onItemClick(S), E),
        ue(S, "mouseover", t, () => f(S, !1)),
        ue(S, "mouseout", t, () => h()));
  }
  u();
  let g = new MutationObserver(u);
  (g.observe(e, { attributes: !1, childList: !0, subtree: !0 }),
    St(e, [a], e, t, (w) => {
      ...
      (w) => {
        ...
        if (Date.now() - (m ?? 0) > Mr) {
          ...
          for (let S of k) {
            ...
            if (
              (S.getAttribute("commandfor") ||
                S.getAttribute("popovertarget")) === e.id
            )
              return;
          }
          e.hidePopover();
        ...
        E.newState === "closed" &&
          ...
          setTimeout(() => {
            (!e.contains(document.activeElement) &&
              ...
              (s && Date.now() < s) ||
              (b && b !== document.activeElement && b.isConnected && Le(b),
              (b = null));
          });
      },
      { signal: t },
  ...
  function f(w, E = !0) {
    let k = p();
    (k !== null && k.setAttribute("tabIndex", "-1"),
  ...
  function h() {
    let w = p();
    (w !== null && w.setAttribute("tabIndex", "-1"),
      (n = null),
  ...
  function v(w, E = !1) {
    ...
    if (
      ...
      re !== -1 &&
      B($) &&
      ($.textContent?.trim().toLowerCase() || "").startsWith(S)
    )
      return $;
    for (let D = re + 1; D < k.length; D++)
      if (
        (k[D].textContent?.trim().toLowerCase() || "").startsWith(S) &&
        B(k[D])
      )
        return k[D];
    for (let D = 0; D <= re; D++)
  ...
  return {
    ignoreNextFocusRestoration: () => (s = Date.now() + 100),
    setActiveItem: f,
    clearActiveItem: h,
    getActiveItem: p,
    findItemBySearchQuery: v,
    handleSearchKey: y,
    hasActiveSearchQuery: T,
  };
}
var ne,
  Ee,
  ...
  tt = class extends A {
    ...
    mount(t) {
      ...
      (r.id || (r.id = P("select-button")),
        z(r, "--button-width", t, this),
        r.addEventListener(
          "keydown",
          (s) => {
              ...
              switch (s.key) {
                ...
                case " ": {
                  if (
                    ...
                    (s.preventDefault(),
                      s.stopPropagation(),
                      d(this, C).handleSearchKey(s.key));
                    break;
                  }
                  (s.preventDefault(),
                    n.hasAttribute("open")
                      ? n.hidePopover()
                      : (n.showPopover(), this.goToItem("selected")));
                  break;
                }
                default: {
                  n.hasAttribute("open") &&
            ...
            switch (s.key) {
              ...
              default: {
                s.key.length === 1 &&
                  ...
                  (s.preventDefault(),
                  s.stopPropagation(),
                  d(this, C) && d(this, C).handleSearchKey(s.key));
                break;
              }
            }
          },
    ...
    onBeforeClose() {
      let t = this.getButton(),
        n = t.dataset.originalTabIndex;
      (delete t.dataset.originalTabIndex,
        n !== void 0
    ...
    set value(t) {
      ...
      if (n) {
        ...
        try {
          this.querySelectorAll("el-selectedcontent").forEach((r) =>
            r.update(),
          );
        } catch {}
      }
...
var ho = class extends A {
  ...
  update() {
    ...
    for (let r of t.childNodes) n.append(r.cloneNode(!0));
...
var go = class extends A {
  ...
  It = class extends A {
            ...
            switch (i.key) {
              ...
              case " ":
                if (
                  ...
                  (i.preventDefault(),
                    i.stopPropagation(),
                    d(this, O).handleSearchKey(i.key));
                  break;
                }
              case "Enter": {
                (i.preventDefault(),
              ...
              default: {
                this.hasAttribute("open") &&
                  ...
                  (i.preventDefault(),
                  i.stopPropagation(),
                  d(this, O) && d(this, O).handleSearchKey(i.key));
                break;
              }
            }
        },
    ...
    onBeforeOpen() {
      let n = this.getDropdown().getButton(),
        r = n.dataset.originalTabIndex;
      (r && (n.dataset.originalTabIndex = r),
        n.setAttribute("tabIndex", "-1"),
        this.getActiveItem() === null &&
    ...
    onBeforeClose() {
      let n = this.getDropdown().getButton(),
        r = n.dataset.originalTabIndex;
      (delete n.dataset.originalTabIndex,
        r !== void 0
...
var vo = class extends A {
  ...
  Pt = class extends A {
    mount(o) {
      ...
      for (let a of n)
        (a.id || (a.id = P("popover-button")),
          a.addEventListener(
            "keydown",
            (l) => {
              (l.key === "Enter" || l.key === " ") &&
                (l.preventDefault(), this.togglePopover());
            },
            { signal: o },
          ));
      (Me(this, o, () => this.getButtons()),
        this.setAttribute("tabindex", "-1"));
      let r = this,
        i = this.closest("el-popover-group");
      (i && i.getPopovers().includes(this) && (r = i),
        St(r, n, this, o, () => this.hidePopover()));
      let s = new AbortController();
      (o.addEventListener("abort", () => s.abort()),
        this.addEventListener("beforetoggle", (a) => {
          if (a.newState === "open") {
            let l = vt(a, n);
    ...
    getButtons() {
      let o = this.id,
        t = Array.from(document.querySelectorAll(`[popovertarget="${o}"]`));
      if (!t)
        throw new Error(
...
var wo = class extends A {
    mount(o) {
      ...
      for (let a = 0; a < i.length; a++) {
        let l = i[a],
          u = r[a];
        (u.id || (u.id = P("tailwindplus-tab")),
          l.id || (l.id = P("tailwindplus-tab-panel")),
          l.setAttribute("aria-labelledby", u.id),
          u.setAttribute("aria-controls", l.id),
    ...
    getActiveTab() {
      let o = this.querySelector("el-tab-panels"),
        t = o.getPanels().find((n) => !n.hasAttribute("hidden"));
  ...
  Eo = class extends A {
    mount() {
      let t = this.getTabGroup().getList(),
        n = this.getPanels(),
      ...
      for (let i of n)
        (i.setAttribute("role", "tabpanel"),
          ...
          r.observe(i, { attributeFilter: ["hidden"], attributes: !0 }));
    }
    getTabGroup() {
      ...
      (n) => {
        ...
        return navigator.clipboard
          ...
          .finally(() => {
            ...
            s.signal.addEventListener("abort", () => clearTimeout(l), {
              once: !0,
            });
          });
      },
