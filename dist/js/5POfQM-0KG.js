  ...
  document.addEventListener(
    ...
    (o) => {
      ...
      if (t && t.method === "dialog") {
        ...
        if (
          r === !0 ||
          (o.preventDefault(), o.stopImmediatePropagation(), r === !1)
        )
          return;
        r.then((i) => {
          i && ((e = !0), t.dispatchEvent(o));
        }).catch(console.error);
      }
    },
    !0,
  ...
  Object.defineProperties(HTMLDialogElement.prototype, {
    close: {
      value() {
        ...
        let o = e.beforeClose();
        if (o === !0) return He?.apply(this, arguments);
        o !== !1 &&
          o
            .then((t) => (t ? He?.apply(this, arguments) : null))
            .catch(console.error);
      },
    },
  }),
  document.addEventListener(
    ...
    (e) => {
      ...
      n !== !0 &&
        ...
        e.preventDefault(),
        n !== !1 &&
          n.then((r) => (r ? He?.apply(o) : null)).catch(console.error));
    },
    !0,
  ));
var Q,
      ...
      return new Promise((n) => {
        d(this, ye)?.start("out", () => {
          t.aborted ||
            (I(this, Q, null),
            requestAnimationFrame(() => {
              let r = this.getNativeDialog(),
                i = r.style.cssText;
              ((r.style.cssText = i + "transition-duration: 0 !important;"),
                He?.apply(r),
                requestAnimationFrame(() => {
                  r.style.cssText = i;
                }));
